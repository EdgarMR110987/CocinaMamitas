...
<form action="" method="post" id="agregarProducto">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-1 izquierda">
                <?php $perfil = $editarVenta->obtenerPerfilClienteController($datos_venta["id_cliente_venta_c"]); ?>
                <input type="hidden" name="perfil" value="<?php echo $perfil["perfil"]; ?>">
                <input type="hidden" name="id_venta_agregar_p" id="id_venta_c" value="<?php echo $datos_venta["id_venta_c"]; ?>">
                <input type="hidden" id="id_cliente_venta_c" value="<?php echo $datos_venta["id_cliente_venta_c"]; ?>">
                <input type="hidden" name="estado_venta_c" value="<?php echo $datos_venta["forma_pago_venta_c"]; ?>">
            ...
            <div id="panel-categorias" class="col-md-7">                
                    <?php
                        $editarVenta->vistaCategoriasVentaController();
                    ?>
            </div>
    ...
    <?php
        ...
        $agregar->agregarNuevaPartidaVentaEditarController();
    ?>
</form>
    ...
    <div id="openModalEliminar" class="modalDialog">
        <div class="preguntar">
            <div class="modal-header">
                ...
                <input type="hidden" name="id_cliente_venta_c" id="id_cliente_venta_c" value="<?php echo $datos_venta["id_cliente_venta_c"]; ?>">
