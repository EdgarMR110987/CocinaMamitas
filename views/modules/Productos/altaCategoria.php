...
<div class="container mt-6">
    <h4 class="mb-3 centrar">Alta de Categoria</h4>
    <form action="" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-4 izquierda mb-3">
                <input class="input-form mayusculas" type="text" name="descripcion_cat" id="descripcion_cat" placeholder="Nombre de la categoria">
            </div>
            <div class="col-md-2 derecha mb-3">
                <span>Foto : </span>
            </div>
...
$registrar -> registroCategoriaController();
?>